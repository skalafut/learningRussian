...
void LanguageGame::reviewMode(){
	...
	do{
		...
		if(_indexesAlreadyShown.size() == _mapBtwnLanguages.size() ){
			std::cout<<"you cycled through all of the words and phrases in englishToItalianList.txt !  Good work!  Add more words or phrases to this file."<<std::endl;
			break;
		}
...
void LanguageGame::testMode(bool doOfficeMode){
	...
	do{
		...
		incrementNumTested();
		if(_indexesAlreadyShown.size() == _mapBtwnLanguages.size() ){
			std::cout<<"you cycled through all of the words in englishToItalianList.txt !  Good work!  Add more words or phrases to this file."<<std::endl;
			break;
		}
